          ...
          <div class="ml-4 flex items-center md:ml-6">
            ...
            <el-dropdown class="relative ml-3">
              <button class="relative flex max-w-xs items-center rounded-full bg-gray-800 text-sm focus:outline-hidden focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-offset-2 focus-visible:ring-offset-gray-800">
                ...
                <img src="https://images.laracasts.com/series/thumbnails/png/laravel-api-master-class.png?tr=w-160" alt="" class="size-8 rounded-full" />
              </button>
            </el-dropdown>
          </div>
        </div>
    ...
    <el-disclosure id="mobile-menu" hidden class="block md:hidden">
      ...
      <div class="border-t border-gray-700 pt-4 pb-3">
        <div class="flex items-center px-5">
          <div class="shrink-0">
            <img src="https://images.laracasts.com/series/thumbnails/png/laravel-api-master-class.png?tr=w-160 alt="" class="size-10 rounded-full" />
          </div>
          <div class="ml-3">
